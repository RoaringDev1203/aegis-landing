...
export const Partners = () => {
  ...
  return (
    <>
    <div className='w-full mx-4 justify-center items-center space-y-8'>
        <h1 className='text-6xl text-center text-white font-black '>Partners</h1>
        <div className='flex justify-center items-center space-x-[64px] mt-8 border-1 border-t-1 border-b-1 border-neutral-700'>
            {
...
</svg> <h1 className='text-xl text-white font-medium'>{partner.name}</h1></div>
                    </div>
                ))
            }
        </div>
