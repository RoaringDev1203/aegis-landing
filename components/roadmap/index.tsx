...
export const Roadmap = () => {
  return (
    <>
    <div id="home" className="bg-home w-full min-h-screen pt-[200px] px-16">
      <div className="py-2 w-full">
      <h1 className='text-6xl text-center text-white font-black '>Roadmap</h1>
      <div className='flex mt-20 h-[8px] justify-between relative mx-4 ' style={{
        "background": "linear-gradient(to right, white 25%,#27272A 50%)",

      }}>
    <div className='p-4 bg-white rotate-45 mb-2 absolute -top-3'>
    </div>

    <div className='p-4 bg-[#27272A] rotate-45 rounded-full absolute right-0 -top-3 '>

    </div>
</div>
      <div className="flex justify-center space-x-40 ">

<div className="flex-cols list-none text-white  relative border-r-4 border-white " style={{
    "background": "linear-gradient(to left, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0.00) 40.47%)"
  }}>
  <button className='bg-[#27272A] text-white text-center px-8 py-2 rounded-full absolute -top-6 left-[126px]'>Phase 1</button>
...
<button className='bg-[#27272A] text-white text-center px-8 py-2 rounded-full absolute -top-6 right-[85px]'>Phase 2</button>
...
<div className="flex-cols list-none text-white h-[131px] text-center relative">
<button className='bg-[#27272A] text-white text-center px-8 py-2 rounded-full absolute -top-6 left-[105px]'>Phase 3</button>
<ul className='space-y-3 mt-8'>
